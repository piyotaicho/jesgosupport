...
import regCC from './2025年子宮頸がん腫瘍登録.json'
import regEM from './2025年子宮体がん腫瘍登録.json'
import regOV from './2025年卵巣がん腫瘍登録.json'
import checkCC from './子宮頸がん登録確認 (2023-2026).json'
import checkEM from './子宮体がん登録確認 (2023-2026).json'
import checkOV from './卵巣がん登録確認 (2023-2026).json'
