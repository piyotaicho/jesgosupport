...
module.exports = {
  ...
  entry: {
    ...
    'GOCCcheck2325-single': './jesgo-plugin/src/GOCCcheck.ts',
    'GOEMcheck2324-single': './jesgo-plugin/src/GOEMcheck.ts',
    'GOOVcheck2325-single': './jesgo-plugin/src/GOOVcheck.ts',
    'GOTDcheck2324-single': './jesgo-plugin/src/GOTDcheck.ts',
    'GOUAcheck2324-single': './jesgo-plugin/src/GOUAcheck.ts',
    'GOUScheck2324-single': './jesgo-plugin/src/GOUScheck.ts',
    'GOVACcheck2324-single': './jesgo-plugin/src/GOVACcheck.ts',
    'GOVUCcheck2324-single': './jesgo-plugin/src/GOVUCcheck.ts',
    // 単純書き出しプラグイン
